...
{
    const char* pszTimestamp = "Former Interpol chief Meng Hongwei being probed for accepting bribes, says China";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 2080000;
        ...
        genesis = CreateGenesisBlock(1539268496, 2084948247, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaee61b7d5e96bff1567801b51c379111f05135e5dc5faec70302f18a006dab4d"));
        assert(genesis.hashMerkleRoot == uint256S("0x65c497cd3bb8f91c832318d70a00515d3379749923ef4c4ef430efa60d8c4553"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.vccointools.com", true);
        vSeeds.emplace_back("seed-b.vccoin.loshan.co.uk", true);
