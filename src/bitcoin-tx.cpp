...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vccoin transaction") + "\n" +
              "  vccoin-tx [options] -create [commands]   " + _("Create hex-encoded vccoin transaction") + "\n" +
              "\n";
