...
const char * const BITCOIN_CONF_FILENAME = "vccoin.conf";
const char * const BITCOIN_PID_FILENAME = "vccoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "vccoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/vccoin";
#else
    // Unix
    return pathRet / ".vccoin";
#endif
#endif
}
