...
#if defined(NDEBUG)
# error "vccoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "vccoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s VCC additional fees, %d delta bytes\n",
